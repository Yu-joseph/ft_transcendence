import { Calendar, Clock, Edit, Fingerprint, Mail, MessageCircle, Shield, Trophy, UserPlus, UserX } from "lucide-react";
...
export function ProfileHeader({ isOwnProfile, setIsOwnProfile, setUserId }: ProfileHeaderProps) {
    const { user } = useAuth();
